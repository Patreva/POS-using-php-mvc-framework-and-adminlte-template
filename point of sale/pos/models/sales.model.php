...
class ModelSales{
	...
	static public function mdlAddSale($table, $data){
		...
		$stmt = Connection::connect()->prepare("INSERT INTO $table(code, idSeller, products, tax, netPrice, totalPrice, paymentMethod) VALUES (:code, :idSeller, :products, :tax, :netPrice, :totalPrice, :paymentMethod)");
	...
	static public function mdlEditSale($table, $data){
		...
		$stmt = Connection::connect()->prepare("UPDATE $table SET  idSeller = :idSeller, products = :products, tax = :tax, netPrice = :netPrice, totalPrice= :totalPrice, paymentMethod = :paymentMethod WHERE code = :code");
